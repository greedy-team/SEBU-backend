...
public class AuthCookieFactory {
    ...
    public static final String RECOVERY_COOKIE = "recovery_token";
    private static final String ACCESS_PATH = "/api/v1";
    private static final String REFRESH_PATH = "/api/v1/auth";
    private static final String RECOVERY_PATH = "/api/v1/auth/recovery";
    ...
    public ResponseCookie recovery(String value, long expiresIn) {
        return base(RECOVERY_COOKIE, RECOVERY_PATH, value).maxAge(Duration.ofSeconds(expiresIn)).build();
    }
    ...
    public ResponseCookie deleteRecovery() {
        return recovery("", 0);
    }
